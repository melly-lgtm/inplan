...
export const EN: Catalog = {
  ...
  "newdoc.limitTitle": "Document limit reached",
  "newdoc.limitBody": "You’re at your {limit}-document limit. Deactivate the least-recently-used “{title}” to make room?",
  "newdoc.deactivateAndCreate": "Deactivate & create",
  "newdoc.limitCancelled": "Cancelled — no document was created.",
  ...
  "onboarding.layout.title": "Arrange the panes",
  "onboarding.layout.body": "These buttons show one, two, or three panes — the preview, the Markdown source, and the comments. Switch the layout now to see them.",
  "onboarding.source.title": "Edit the Markdown source",
  "onboarding.source.body": "The source pane holds the raw Markdown. Type a change there and the preview updates live. Try editing a line.",
  "onboarding.movedoc.title": "Split off a new document",
  "onboarding.movedoc.body": "As a plan grows, select a section, right-click, and choose “Move to New Doc” to break it into its own linked document. (Just a heads-up — no need to do it now.)",
  "onboarding.finishturn.title": "Hand the turn back",
  "onboarding.finishturn.body": "When you're done editing, the paper-plane button finishes your turn and hands control to the agent so it can revise. (Nothing is sent during this tour.)",
  ...
  "tabs.source": "Source",
  // source pane — formatting toolbar
  "source.heading": "H",
  "source.headingTitle": "Heading",
  ...
  "source.strikethrough": "Strikethrough",
  "source.hr": "Horizontal rule",
  "source.quote": "Quote",
  "source.bulletList": "Bullet list",
  "source.orderedList": "Numbered list",
  ...
  "banner.proposalQueue": "{n} proposals await your review (oldest shown first).",
  "banner.queuePosition": "1 of {n}",
  ...
  "msg.queueRefreshFailed": "Could not check for the next queued proposal — it will surface on the next park or reload.",
  ...
  "banner.allChanges": "accept or reject all changes",
  "banner.allAccepted": "All changes accepted — click to reject all",
  "banner.allRejected": "All changes rejected — click to accept all",
  "banner.allMixed": "Some changes accepted — click to accept all",
  "banner.apply": "Apply",
